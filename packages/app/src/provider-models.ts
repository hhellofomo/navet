import type { IntegrationProviderId, NavetProviderSession } from '@navet/core';
...
// should prefer provider-neutral NavetEntity from @navet/core/types.
...
export type { NavetProviderSession };
