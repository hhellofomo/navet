...
Navet is a smart-home dashboard PWA for Home Assistant. It runs as a standalone Docker app, a Home Assistant add-on through ingress, and a Home Assistant custom panel.
