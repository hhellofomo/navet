...
import type { HomeySnapshot } from '@/app/types/homey';
...
vi.mock('@/app/services/homey-api-client.service', () => ({
  ensureHomeyApiClientConfigured: ensureHomeyApiClientConfiguredMock,
}));

vi.mock('@/app/services/homey.service', () => ({
  homeyService: {
...
runProviderContractTests({
  providerName: 'Homey',
  createAdapter: () => createHomeyContractAdapter(),
