...
const getInactiveThemeTone = (themeType: ThemeType) => {
  if (themeType === 'light') {
    return {
      gradient: 'from-gray-100/60 to-gray-200/40',
      border: 'border-gray-200/50',
      iconBg: 'bg-gray-300/35',
  ...
  if (themeType === 'glass') {
    return {
      gradient: 'from-white/12 via-white/06 to-white/04',
  ...
  return {
    gradient: 'from-gray-900/32 to-gray-950/24',
...
const generateThemeColors = (
  ...
  if (themeType === 'glass') {
    return {
      light: {
        gradient: `from-white/26 via-${color}-200/18 to-white/10`,
        border: `border-white/22`,
        iconBg: `bg-${color}-300/18`,
        glow: `from-${color}-300/18`,
      },
      hvac: {
        heating: {
          gradient: 'from-white/24 via-orange-200/20 to-white/10',
          border: 'border-white/22',
        ...
        cooling: {
          gradient: 'from-white/24 via-cyan-200/20 to-white/10',
          border: 'border-white/22',
          iconBg: 'bg-cyan-300/22',
