export const svMessages = {
  ...
  'sections.tasks.description':
    'Kör och hantera Home Assistant-automationer som håller dina hemrutiner igång.',
  'sections.tasks.emptyTitle': 'Inga uppgifter',
  'sections.tasks.emptyDescription':
    'Du har inga Home Assistant-automationer tillgängliga ännu. Lägg till automationer för att få in dina rutiner i Uppgifter.',
  ...
  'tasks.automation.details.noDescription':
    'Home Assistant exponerade ingen beskrivning för denna automation.',
