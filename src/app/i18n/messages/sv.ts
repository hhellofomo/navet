export const svMessages = {
  ...
  'dashboard.roomNav.reorderDialog.description':
    'Ordna om rum eller ta bort Home Assistant-rum som inte längre behövs.',
  ...
  'login.errors.tokenInvalid': 'Ange en långlivad atkomsttoken utan mellanslag eller radbrytningar',
  ...
  'sidebar.orbit': 'Orbit',
  'sidebar.orbitTitle': 'Sektionsorbit',
