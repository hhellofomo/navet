export const frMessages = {
  ...
  'sections.tasks.description':
    'Declenchez et gerez les automatisations Home Assistant qui font tourner vos routines.',
  'sections.tasks.emptyTitle': 'Aucune tâche',
  'sections.tasks.emptyDescription':
    'Vous n’avez pas encore d’automatisations Home Assistant disponibles. Ajoutez des automatisations pour retrouver vos routines dans Taches.',
  ...
  'tasks.automation.details.noDescription':
    'Home Assistant n a fourni aucune description pour cette automatisation.',
