export const esMessages = {
  ...
  'sections.tasks.description':
    'Activa y gestiona las automatizaciones de Home Assistant que mantienen tus rutinas en marcha.',
  'sections.tasks.emptyTitle': 'No hay tareas',
  'sections.tasks.emptyDescription':
    'Todavía no tienes automatizaciones de Home Assistant disponibles. Agrega automatizaciones para llevar tus rutinas a Tareas.',
  ...
  'tasks.automation.details.noDescription':
    'Home Assistant no expuso una descripción para esta automatización.',
