export const deMessages = {
  ...
  'sections.mock.title': 'Temporäre Mock-Entitäten',
  'sections.mock.description':
    'Dieser Bereich enthält Ihre lokalen Mock-Entitäten, damit Sie Karten weiter anzeigen können, die noch nicht vollständig in das live verbundene Home-Assistant-Dashboard integriert sind.',
