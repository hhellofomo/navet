export const deMessages = {
  ...
  'settings.appearance.wallpaper.stockTitle': 'Integrierte Hintergründe',
  'settings.appearance.wallpaper.stockDescription':
    'Ruhige integrierte Motive, die hinter Glasflächen und Akzent-Overlays gut funktionieren.',
  'settings.appearance.wallpaper.stock.sereneDawn': 'Sanfter Morgen',
  'settings.appearance.wallpaper.stock.starfieldNocturne': 'Sternennacht',
  'settings.appearance.wallpaper.stock.auroraVeil': 'Polarlichtschleier',
  'settings.appearance.wallpaper.stock.rainforestCanopy': 'Regenwaldkronen',
