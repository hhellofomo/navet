export const deMessages = {
  ...
  'sections.tasks.description':
    'Starte und verwalte die Home-Assistant-Automationen, die deine Routinen am Laufen halten.',
  'sections.tasks.emptyTitle': 'Keine Aufgaben',
  'sections.tasks.emptyDescription':
    'Es sind noch keine Home-Assistant-Automationen verfügbar. Fügen Sie Automationen hinzu, um Ihre Routinen in Aufgaben anzuzeigen.',
  ...
  'tasks.automation.details.noDescription':
    'Home Assistant stellt keine Beschreibung für diese Automation bereit.',
