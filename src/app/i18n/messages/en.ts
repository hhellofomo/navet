export const enMessages = {
  ...
  'dashboard.roomNav.reorderDialog.description':
    'Reorder rooms or delete Home Assistant rooms you no longer need.',
  ...
  'login.errors.tokenInvalid': 'Enter a long-lived access token without spaces or line breaks',
  ...
  'sidebar.orbit': 'Orbit',
  'sidebar.orbitTitle': 'Section orbit',
