export const enMessages = {
  ...
  'settings.appearance.wallpaper.stockTitle': 'Built-in wallpapers',
  'settings.appearance.wallpaper.stockDescription':
    'Calm bundled scenes that work well behind glass surfaces and accent overlays.',
  'settings.appearance.wallpaper.stock.sereneDawn': 'Serene Dawn',
  'settings.appearance.wallpaper.stock.starfieldNocturne': 'Starfield Nocturne',
  'settings.appearance.wallpaper.stock.auroraVeil': 'Aurora Veil',
  'settings.appearance.wallpaper.stock.rainforestCanopy': 'Rainforest Canopy',
