...
export function getRoundControlStyles(theme: ThemeType): RoundControlStyles {
  if (theme === 'light') {
    return {
      ...
      disabledButton: 'bg-gray-100 text-slate-600 opacity-70 cursor-not-allowed',
      softButton:
      ...
      softDisabledButton:
        'border border-white/45 bg-white/40 text-slate-700 opacity-70 cursor-not-allowed backdrop-blur-xl',
  ...
  if (theme === 'glass') {
    return {
      ...
      disabledButton:
        'border border-white/14 bg-[linear-gradient(180deg,rgba(255,255,255,0.14),rgba(255,255,255,0.05))] text-white/78 opacity-70 cursor-not-allowed backdrop-blur-xl',
      softButton:
      ...
      softIcon: 'text-white',
      softDisabledButton:
        'border border-white/12 bg-[linear-gradient(180deg,rgba(255,255,255,0.1),rgba(255,255,255,0.04))] text-white/76 opacity-70 cursor-not-allowed backdrop-blur-xl',
      selectedText: 'text-white',
      emphasisButton:
  ...
  if (theme === 'black') {
    return {
      ...
      defaultIcon: 'text-white',
      disabledButton: 'bg-black text-white/78 opacity-70 cursor-not-allowed border border-zinc-700',
      softButton: 'border border-zinc-700 bg-zinc-950/90 text-white hover:bg-zinc-900',
      softIcon: 'text-white',
      softDisabledButton:
        'border border-zinc-700 bg-zinc-950/90 text-white/78 opacity-70 cursor-not-allowed',
      selectedText: 'text-white',
  ...
  return {
    ...
    defaultIcon: 'text-white',
    disabledButton: 'bg-zinc-800 text-white/78 opacity-70 cursor-not-allowed',
    softButton:
    ...
    softIcon: 'text-white',
    softDisabledButton:
      'border border-white/8 bg-white/8 text-white/76 opacity-70 cursor-not-allowed backdrop-blur-xl',
    selectedText: 'text-white',
