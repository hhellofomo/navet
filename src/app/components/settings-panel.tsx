import { X, LogOut, Palette, Server, Info } from 'lucide-react';
...
export function SettingsPanel({ isOpen, onClose }: SettingsPanelProps) {
  ...
  return (
    <>
      ...
      {/* Full-page panel */}
      <div className={`fixed inset-0 z-50 overflow-hidden md:inset-auto md:right-0 md:top-0 md:bottom-0 md:w-[480px]`}>
          ...
          <div className="flex-1 overflow-y-auto p-4 md:p-6 space-y-6">
            ...
            <section className={`${cardBg} rounded-2xl border ${borderColor} overflow-hidden`}>
              <div className="p-4 md:p-5 border-b border-white/10">
                <div className="flex items-center gap-3">
                  <div className={`w-10 h-10 rounded-xl ${theme === 'light' ? 'bg-gray-100' : 'bg-white/5'} flex items-center justify-center`}>
              ...
              <div className="p-4 md:p-5 space-y-6">
                {/* Theme Mode */}
                <div>
                  <label className={`text-sm font-medium ${textColor} block mb-3`}>Theme Mode</label>
                ...
                {/* Primary Color */}
                <div>
                  <label className={`text-sm font-medium ${textColor} block mb-3`}>Primary Color</label>
            ...
            <section className={`${cardBg} rounded-2xl border ${borderColor} overflow-hidden`}>
              ...
              <div className="p-4 md:p-5">
                <div className={`p-4 rounded-xl border ${borderColor} ${theme === 'light' ? 'bg-gray-50' : 'bg-white/5'}`}>
