  ...
  return (
    <div className={`flex items-start justify-between ${marginBottom}`}>
      <div className="min-w-0 flex-1">
        <h3 className={`font-semibold ${titleColor} truncate ${titleSize} transition-colors duration-500`}>
          {title}
        </h3>
      </div>
      {icon && (
        <div className={`${iconSize} rounded-full ${iconBgColor} flex items-center justify-center flex-shrink-0 transition-all duration-500`}>
