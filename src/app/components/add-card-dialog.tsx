...
import { X, Calendar, Newspaper, Cloud, Image, StickyNote } from 'lucide-react';
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {cardTemplates.map((template) => (
                <button
                  ...
                  style={{
                    borderColor: selectedType === template.id ? getColorValue(primaryColor) : undefined,
                  }}
                >
                  <div className="flex items-start gap-3">
                    <div 
                      ...
                      style={{
                        backgroundColor: selectedType === template.id 
                          ? `${getColorValue(primaryColor)}20`
                          : theme === 'light' ? '#f3f4f6' : 'rgba(255, 255, 255, 0.05)',
                        color: selectedType === template.id ? getColorValue(primaryColor) : undefined,
                      }}
                    >
                      {template.icon}
                    </div>
