...
import { ColorTemperaturePresets } from '../shared/color-temperature-presets';
import { ColorPicker } from '../shared/color-picker';
import { TEMP_OPTIONS, PRESET_COLORS } from '../../constants/light-constants';
  ...
  return (
    <>
      ...
      <div className="flex-1 flex flex-col justify-between">
        ...
        {/* Color temperature picker with gradient */}
        <div className="space-y-2 mb-2">
          <div className={`text-xs ${secondaryTextColor}`}>Color temperature</div>
          <label
            className="w-12 h-12 rounded-full transition-all duration-300 flex items-center justify-center cursor-pointer relative overflow-hidden bg-gradient-to-r from-amber-600 via-yellow-200 to-blue-200 hover:scale-105"
          ...
          >
            ...
            />
            <div className={`w-6 h-6 rounded-full backdrop-blur-sm flex items-center justify-center pointer-events-none ${
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center gap-2">
            <div className="flex gap-2 flex-1">
              ...
              />
              <label
                className="w-12 h-12 rounded-full bg-gradient-to-br from-red-500 via-yellow-500 via-green-500 via-blue-500 to-purple-500 hover:scale-105 transition-all flex items-center justify-center cursor-pointer relative overflow-hidden"
                title="Custom color"
                onClick={(e) => e.stopPropagation()}
              >
                <input
            ...
            <button
              ...
              className={`w-12 h-12 rounded-full ${buttonBg} transition-all flex items-center justify-center ml-auto`}
            >
              <Settings className={`w-4 h-4 ${buttonText}`} />
            </button>
          </div>
        </div>
      </div>
