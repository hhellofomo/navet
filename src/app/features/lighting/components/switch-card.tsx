...
export const SwitchCard = memo(function SwitchCard({
  ...
  const iconBadgeClass =
    theme === 'light' ? (isOn ? 'bg-blue-200/80' : 'bg-gray-300/70') : cardColors.iconBg;
  const iconColorClass =
    theme === 'light' ? (isOn ? 'text-blue-700' : 'text-gray-600') : cardColors.accent;
      ...
      <div className="relative h-full flex flex-col">
        <div className="flex items-start justify-between mb-2">
          <div className="min-w-0 flex-1">
            ...
            <p className="text-[10px] text-gray-400 truncate mt-0.5 text-left">{entityType}</p>
          </div>
          <div
