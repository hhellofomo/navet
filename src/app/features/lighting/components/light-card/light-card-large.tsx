...
import { PRESET_COLORS } from '../../constants/light-constants';
			...
			<div className="flex-1 flex flex-col justify-between">
				...
				<div className="space-y-2 mb-2">
					...
					>
						...
						/>
						<div
							className={`w-6 h-6 rounded-full backdrop-blur-sm flex items-center justify-center pointer-events-none ${
							...
							<label
								...
								onKeyDown={(e) => {
									if (e.key === 'Enter' || e.key === ' ') {
										e.preventDefault();
										(
											e.currentTarget.querySelector('input[type="color"]') as HTMLInputElement
										)?.click();
									}
								}}
								tabIndex={isOn ? 0 : -1}
