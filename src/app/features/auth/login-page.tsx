...
import { Eye, EyeOff, Home, Key, AlertCircle, Loader2 } from 'lucide-react';
    ...
    try {
      ...
      if (isValid) {
        ...
        if (success) {
          ...
          console.warn('Connection test failed but login succeeded. This is normal in development due to CORS restrictions.');
        } else {
          setError('Failed to save configuration');
        }
      }
