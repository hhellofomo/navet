...
import type { NoteWidget, PhotoFrameWidget } from '@/app/features/dashboard/components/widgets';
import type { MapMarker } from '@/app/features/dashboard/components/widgets/map-types';
import type { MapWidget } from '@/app/features/dashboard/components/widgets/map-widget';
import type { EnergySeriesPoint } from '@/app/features/energy';
import type { FanCard, LightCard, SwitchCard } from '@/app/features/lighting';
import type { MediaCard } from '@/app/features/media';
import type { PersonCard } from '@/app/features/person';
import type { RSSItem, RSSProvider } from '@/app/features/rss/components/rss-feed-card/types';
import type { SceneCard } from '@/app/features/scenes';
import type { CameraCard, CoverCard, LockCard } from '@/app/features/security';
import type { GroupedSensorCard, InfoCard } from '@/app/features/sensors';
